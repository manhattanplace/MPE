...
<html lang="en">
<head>
<title>New York Rangers "I Am A Ranger" Location</title>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            ...
            <div id="video">
            <script>
               QT_WriteOBJECT('iamaranger_location.mov', '641', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;
            </script>
            </div>
