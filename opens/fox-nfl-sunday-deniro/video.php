...
<html lang="en">
<head>
<title>FOX NFL Sunday - Season Opener</title>
    ...
    <div class="panel">
        ...
        <div class="container">
            <div class="back_button1">
                <a href="/opens.php">&laquo; Back to Opens</a>
            </div>
            <div id="video">
                <script>QT_WriteOBJECT('/videos/fox-nfl-sunday-deniro/fox-nfl-sunday-deniro.mov', '640','376','', 'AUTOPLAY','True','SCALE','Aspect') ;</script>
            </div>
