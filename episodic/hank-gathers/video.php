...
<html lang="en">
<head>
<title>Hank Gathers's Son Finds New Meaning As A Mentor</title>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            ...
            <div id="video">
                <script>QT_WriteOBJECT('/videos/hank-gathers/hank-gathers.mov', '640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect');</script>
            </div>
