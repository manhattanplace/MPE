...
<head>
<title>St. Vincent's Medical Center "Darren"</title>
...
<body>
    ...
    <div class="panel">
		...
		</div>        <h3 title="Commercial Reel for Manhattan Place Entertainment" class="library">COMMERCIALS</h3>
        <div class="container">
            ...
            <div id="video">
            <script>
                QT_WriteOBJECT('st-vincent-medical-center-darren.mov', '638', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;  
            </script>
            </div>
