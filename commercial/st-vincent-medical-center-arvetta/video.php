...
<head>
<title>St. Vincent's Medical Center "Arvetta"</title>
<meta name="description" content="Commercial Spot Directed by Steve Cohen for St. Vincent's Medical Center">
<meta charset="UTF-8">    
<!--[if IE 7]>
...
<body>
    ...
    <div class="panel">
        ...
        <h3 title="Commercial Reel for Manhattan Place Entertainment" class="library">COMMERCIALS</h3>
        <div class="container">
            <div class="back_button1">
            	<a href="../../commercial.php">&laquo; Back to Commercials</a>
            </div>
                <div id="video"><script>QT_WriteOBJECT('st-vincent-medical-center-arvetta.mov', '638', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;</script>
            </div>
