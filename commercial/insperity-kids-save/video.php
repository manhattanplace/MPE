...
<head>
<title>Insperity Kids Save</title>
<meta name="description" content="Steve Cohen was DP for this Commercial Spot for Insperity Kids">
<meta charset="UTF-8">       
<!--[if IE 7]>
    ...
    <div class="panel">
        ...
        <h3 title="Commercial Reel for Manhattan Place Entertainment" class="library">COMMERCIALS</h3>
            <div class="container">
                ...
                <div id="video">
                    <script>QT_WriteOBJECT('insperity-kids-save.mov', '638', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect');</script>
                </div>
