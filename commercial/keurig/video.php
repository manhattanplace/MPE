...
<html lang="en">
<head>
<title>"What's in your Target cart?"</title>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            ...
            <div id="video">
                <script>QT_WriteOBJECT('keurig.mov','640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;</script>
            </div>
...
<!-- Google Analytics -->
<script>
  var _gaq = _gaq || [];  _gaq.push(['_setAccount', 'UA-17516374-1']);  _gaq.push(['_trackPageview']); (function() { var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true; ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);})();
</script>
