...
<head>
<title>Venus And Serena "Serving Others" - 
Ronald McDonald House</title>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            ...
            <div id="video">
                <script>QT_WriteOBJECT('ronald_mcdonald_house.mov', '640', '496', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;</script>
            </div>
