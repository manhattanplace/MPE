...
<html lang="en">
<head>
<title>FDA Anti-Smoking WWE Daniel Bryan PSA</title>
    ...
    <div class="panel">
        ...
        <div class="container">
            <div class="back_button1">
            	<a href="/psa.php">&laquo; Back to PSA'S</a>
            </div>
            <div id="video">
                <script>QT_WriteOBJECT('/videos/daniel-bryan-psa/daniel-bryan-psa.mov', '640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;</script>
            </div>
