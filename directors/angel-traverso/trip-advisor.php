...
<html lang="en">
<head>
<title>Angel Traverso - Trip Advisor</title>
    ...
    <div class="panel">
    	...
    	<div class="container">
    		<div class="back_button1">
    			<a href="/directors/angel-traverso.php">&laquo; Angel Traverso</a>
    		</div>
    		<div id="video">
    		<script>
    		    QT_WriteOBJECT('/videos/trip-advisor/trip-advisor.mov','640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;
    		</script>
    		</div>
