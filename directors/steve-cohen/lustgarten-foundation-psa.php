...
<html lang="en">
<head>
<title>Denis Leary - Lustgarten Foundation PSA</title>
    ...
    <div class="panel">
    	...
    	<div class="container">
    		<div class="back_button1">
    			<a href="/directors/steve-cohen.php">&laquo; Steve Cohen</a>
    		</div>
    		<div id="video">
    		<script>
    		    QT_WriteOBJECT('/videos/lustgarten-foundation-psa/lustgarten-foundation-psa.mov','640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;
    		</script>
    		</div>
