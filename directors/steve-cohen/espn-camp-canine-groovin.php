...
<html lang="en">
<head>
<title>ESPN SportsCenter "Camp Canine Groovin"</title>
...
<body>
    ...
    <div class="panel">
    	...
    	<div class="container">
    		...
    		<div id="video">
    		<script>
    		    QT_WriteOBJECT('/videos/espn-camp-canine-groovin/espn-camp-canine-groovin.mov','640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;
    		</script>
    		</div>
