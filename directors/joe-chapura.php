    ...
    <div class="panel">
        ...
        <div class="container directors">
            ...
            <div id="three" class="modal">
                <a class="close" href="">close</a>
                <video width="640" controls>
                  <source src="../videos/sprite-hospital/sprite-hospital.mp4" type="video/mp4">
                  <source src="../videos/sprite-hospital/sprite-hospital.ogg" type="video/ogg">
                  <source src="../videos/sprite-hospital/sprite-hospital.webm" type="video/webm">
                </video> 
            </div>
