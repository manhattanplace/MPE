...
<html lang="en">
<head>
<title>Joe Chapura - Sprite 24 Hours to do Your Thing</title>
    ...
    <div class="panel">
    	...
    	<div class="container">
    		<div class="back_button1">
    			<a href="/directors/joe-chapura.php">&laquo; Joe Chapura</a>
    		</div>
    		<div id="video">
    		<script>
    		    QT_WriteOBJECT('/videos/sprite-24/sprite-24.mov','640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;
    		</script>
    		</div>
