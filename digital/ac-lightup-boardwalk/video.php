...
<html lang="en">
<head>
<title>AC Lights Up The Boardwalk</title>
<meta name="description" content="AC Lights Up The Boardwalk">
<meta charset="UTF-8">    
<!--[if IE 7]>
...
<body>
    ...
    <div class="panel">
    	...
    	<div class="container">
    		...
    		<div id="video">
    		    <script>QT_WriteOBJECT('ac-lightup-boardwalk.mov', '640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect');</script>
    		</div>
