...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
    		<p class="garage hotr"><span class="description">Production Services:</span><br />Manhattan Place Entertainment</p>
            <div class="back_button1">
            	<a href="../../index.php">&laquo; Back to Home</a>
            </div>        
            <div id="video_550">
                <script>QT_WriteOBJECT('hotr99.mov', '640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;</script>
            </div><!-- end video -->
