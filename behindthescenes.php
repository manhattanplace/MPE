...
<div class="panel rw">
    ...
    <div class="wrapper">
        ...
        <ul id="nav_tertiary">
            ...
            <li><a href="#mikem">Mike McCarthy Named Co-Chairman</a></li>
            ...
            <li><a href="#kane">Is Kane Able?</a></li>
            <li><a href="#park">From Manhattan Place to Park Avenue</a></li>
            <li><a href="#raw">"Raw Deal"</a></li>
            <li><a href="#tennis">Tennis Anyone?</a></li>
            <li><a href="#trend">Setting A New Trend In "Motion"</a></li>
            ...
            <li><a href="#carcam">The Camera Car is the right Formula for Formula 1</a></li>
            <li><a href="#leary">Denis Leary Joins the Fight for Pancreatic Cancer</a></li>
            <li><a href="#post">MSG Post Season Promo</a></li>
            <li><a href="#goglam">Manhattan Place Goes Glam</a></li>
            <li><a href="#tellys">Manhattan Place Entertainment Wins 2 Tellys</a></li>
            <li><a href="#beyonce">MPE On Target With Beyonce</a></li>
            <li><a href="#spring">Spring Ahead with Glam.com</a></li>
            <li><a href="#backon">Manhattan Place Entertainment gets "Back On Track"!</a></li>
            <li><a href="#rocks">Kohl's Rocks a New Look</a></li>
            <li><a href="#nyr2012">2011-2012 NY Rangers Video Introduction</a></li>
            <li><a href="#brew">Keurig Brews New Coffee Campaign ... with the help of Manhattan Place!</a></li>
            <li><a href="#nyscf">MPE Produces Video For New York Stem Cell Foundation</a></li>
            <li><a href="#nykp">2011/2012 NY Knicks Video Introduction</a></li>
            <li><a href="#fsa">MPE Goes Full Speed Ahead for NASCAR</a></li>
            ...
            <li><a href="#track">MPE helps NASCAR get back on track!</a></li>
            <li><a href="#close">MPE Gets Up Close with Dan Patrick</a></li>
            <li><a href="#depth">"The Depth Chart" on ESPN</a></li>
            <li><a href="#giant">MPE Takes 'Giant' Steps</a></li>
            <li><a href="#commemorating">MPE Remembers 9/11</a></li>
            <li><a href="#thomas">Thomas &amp; Friends™!</a></li>
            <li><a href="#pan">MPE Takes off with 'Pan Am'</a></li>
            <li><a href="#boys">MPE and the Boys</a></li>
            <li><a href="#telly">MPE Wins Two More Telly Awards!</a></li>
            <li><a href="#damages">MPE Doing Some 'Damages'</a></li>
            <li><a href="#vincent">MPE Produces St. Vincent Medical Center Cancer Awareness Commercials!</a></li>
            <li><a href="#michael-douglas">MPE Makes it to their 8th Super Bowl!</a></li>
            <li><a href="#lombardi">"Lombardi" delivers stirring Pre-Game speech to Packers</a></li>
            <li><a href="#indy">MPE Works with VERSUS to shoot Indy Car Portraits!</a></li>
            <li><a href="#ten">Manhattan Place Entertainment Wins 10 More Telly Awards!</a></li>
            <li><a href="#eagle">MPE Wins 3 Cine Eagle Awards!</a></li>
        ...
        <div class="article">
            ...
            <p>"This is the third year in a row that we have had the honor of working with St. Vincent's. It is always rewarding for MPE because we get to see first hand some of the great things that this institution is doing to help people with life threatening health issues", said Steve Cohen, President of Manhattan Place Entertainment.</p>
            <p>Paula Marker, Manager, Marketing Communications at St Vincent's Hospital added, "Shooting in a hospital is never easy and then add in that we were shooting in an Operating Room on an active Operating Room suite hallway and you can understand the constraints MPE had to work with. They took a difficult complex situation and made it look simple. The end product was perfect! I couldn't have asked for better"</p>
        ...
        <div class="article">
            ...
            <p>Manhattan Place Entertainment was proud to be selected by FOX Sports to shoot this retrospective.  Bernie Kim produced, and the piece was shot on location with Tim McCarver in New York City two days before the game.</p>
            <p>Below is our version of the production "before and after".</p>
            <p>BEFORE</p>
            <img class="float_left" src="images/recent-work/before.jpg" alt="Before and After"  />
            <p>A small hotel room in NYC was transformed into a baseball environment that gave Mr. McCarver the appropriate setting and platform to reflect... and share.</p>
            <p style="float:left;width:100%;">AFTER</p>
            <img class="float_left" src="images/recent-work/after.jpg" alt="Before and After"  />
            <p style="margin-top:10px;float:left;width:100%;"><a class="back-to-top" href="#top">Back to Top</a></p>       
        </div>
        <!-- end article -->
        ...
        <div class="article">
            ...
            <p>"The Power of Words" was created in tribute to Nelson Mandela and incorporated text taken from the South African leaders most inspirational writings in an artful display that was synchronized on screens across Times Square.</p>
            <p>"It was an amazing experience witnessing this powerful art piece in the heart of Times Square,"said Steve Cohen who directed for Manhattan Place. "And it was truly an honor and a privilege to meet and interview Mr. Mandela's Grandsons".</p>
            <p>"Midnight Moment: A Digital Gallery" is the largest coordinated effort in history by the sign operators in Times Square to display synchronized, cutting-edge creative content at the same time every day.  Each month, the program presents a new selection to be screened with scheduled appearances every day at exactly 11:57pm. The piece plays for 3 minutes and magically concludes at the moment of midnight.</p>
            <p>Alas, The Midnight Moment.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </div>
        <!-- end article -->     
        ...
        If you have young ones in school, you know that most every classroom these days has an electronic "smartboard" in place of the old chalk and slate some of us are  more familiar with!</p>
            <p>But the folks at WWE needed to go retro for their Extreme Rules promo spot, and they knew exactly who to call!
        Among the most resourceful production companies you'll find, not only can MPE shoot , direct, produce and post produce your content, but they will find the perfect location to shoot in as well!</p>
            <p>In this case the MPE detectives uncovered Assumption school in Fairfield CT, still rocking erasers and the like, lending itself as the perfect setting for a flashback of WWE superstar Sheamus serving detention as"youthful schoolboy".  In the spot, young Sheamus is seen repeatedly writing the phrase "I will not be extreme" on the blackboard, building toward the climax of the spot (you have to watch to see what happens).  The end product was exactly what the WWE folks had in mind-
        The finished spot premiered during Wrestlemania on April 7th.</p>
            <p>So remember,  whether you're in the market for  "Cutting Edge " or your literally looking to go "Old School"   -
        Manhattan Place will "go to the extreme" for you as well.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </div>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>New York's Belmont Park is the sight of this annual event and the commercials showcase the history, beauty and grandeur of the hallowed venue along with the excitement and thundering action that is witnessed during one of sports greatest spectacles.</p>
            <p>Donald Nelson from the NYRA said, "Just like the first time we worked with them, Manhattan Place did an outstanding job.  They not only beat deadlines but provided great creative direction and an exceptional end product that captured the excitement and enthusiasm of our signature event."</p>
            <p>"What people might not know is that we were also prepared to cut an entirely different spot based on the outcome of the Preakness Stakes", said MPE's President and Executive Producer Steve Cohen.</p> 
            <p>"If there was a horse making a bid for the Triple Crown at Belmont, we would've created a spot specifically with that storyline in mind.   But when Oxbow won the Preakness Stakes, and it was determined there would be no Triple Crown winner this year, we stayed in the direction of "The Test of The Champion" spots."</p>
            <p>"But then again,  that's why we love working in sports production, it's unpredictable, which keeps things interesting".</p>
            <p>The spots aired on NBC Sports.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
...
Gus Johnson!</p>
        ...
        <article class="article">
            ...
            <p>Rivera, in most eyes the greatest stopper in the history of the game, made the news with his statements regarding last years post season --"It was torture", Rivera said.  "At one time I was home and I said I have to go there and throw, I was calling the office and they said, "Well you cannot do that, you're not ready."</p>
            <p>Rivera was introduced while his entrance song "Enter Sandman" played in the background as it has for the fifteen years he has pitched for the Yankees at Yankee Stadium. He was inevitably asked about his health (he was out last year with a torn ACL he incurred while shagging flies) and said  "I have my pitching coach here so I can't lie", Rivera said. I feel great, I feel real good."</p>
            <p>Rivera was joined by the aforementioned pitching coach Larry Rothschild, former catcher John Flaherty and former Yankee great David Cone.</p>
            <p>The  event was held to raise funds and awareness for Prostate Cancer.</p>
            <p>For more information on that important effort, see <a href="http://www.fans4thecure.org">it here</a></p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->        
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>At MS 223, teacher Bill Ohl spearheads the effort to solve a simple yet critical need for his students-the need for books.</p>
            <p>"The South Bronx is Ground Zero for childhood poverty", Ohl said. "There are 500,000 residents in the South Bronx, and not a single bookstore to be found -"Donors Choose" allows us to put good books into the hands of kids on a regular basis. 
</p>
            <p>MPE provided the field production as part of a collaboration with the lead production team from "Anatomy" - the video is shown <a href="https://vimeo.com/57555383">here</a></p>
            <p>The video was shown at a fund raising event earlier this month called the "100 Women in Hedge Funds' Gala" and helped raise over 1.4 million dollars for "Donors Choose".</p>
            <p>It is our hope that MPE's friends and clients review the link below and consider a donation to "Donor's Choose" - it is a remarkable effort endorsed by folks such as Oprah Winfrey and Stephen Colbert, who says on the website "You know exactly who you're helping".</p>
            <p>The website presents real teachers, like  Bill Ohl, expressing real needs for real students.</p>
            <p><a href="www.donorschoose.org">www.donorschoose.org</a></p>
            <p>Manhattan Place Entertainment Founder Steve Cohen  said " Like any business we enter into a project to cover our cost and hopefully make a profit-make money. On this project, we simply went in it to make a difference. If we were successful at that, we couldn't be prouder as a company".
</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        ...
        <!-- Begin Article -->  
        <article class="article">
            <h1><a name="mikem" class="anchor">Award Winning Television and Sports Business Executive Mike McCarthy Named Co-Chairman of  Manhattan Place Entertainment</a></h1>
            <p class="date">December 12, 2012</p><hr/>
            <img class="float_left" src="_img/talent-michael-mccarthy.jpg" alt="Mike McCarthy"  />
            <p>Former CEO of the NHL's St. Louis Blues and Long Time Head of Madison Square Garden Networks To Fill New Role With One Of The Broadcast  Industry's Leading  Production Entities</p>
            <p>Manhattan Place Entertainment, one of the nation's leading production and creative services companies, today announced that they have named Mike McCarthy to the newly created position of Co-Chairman. McCarthy, one of the most respected and innovative executives in the entertainment business, joins Manhattan Place after a storied career in business management and broadcast production, most recently as Chief Executive Officer of the St. Louis Blues of the National Hockey League after a trailblazing run with Madison Square Garden Networks. McCarthy will help oversee new business development and brand project growth for Manhattan Place, whose 25 year track record in advertising campaigns, episodic series, branded content, commercials, and on-air promotions for broadcast, the web, or digital platforms, is among the best in the industry.</p>
            <p>"Mike McCarthy brings the exact skill set that will change the game for MPE and all of our partners. His vision and leadership will enable us to broaden the overall scope of what we do and take it to an entirely new level," said Manhattan Place Founder/President Steve Cohen. "We are beyond excited by the prospects of being able to take a concept, make it, and distribute it. If we were a sports franchise, I'd feel like we just signed the most coveted free agent on the market by adding Mike to the organization. We got our lead-off man, cleanup hitter, number 1 starting pitcher and lights out closer all rolled into one!  We're on an emotional high right now because we feel like the skies the limit in terms of where we can go from here."</p>
            <p>"I have seen the exemplary work that Steve and the team have done over the years, and I am looking forward to working with them to further expand their reach for both new and existing clients," McCarthy said. "The entertainment business these days is being driven by creative minds that know how to tell brand stories in every visual means possible, and no one has done that better than Manhattan Place.  It will be exciting to help not just grow the business but the footprint of the industry together as well. The current content landscape is blurred between agencies, production 
companies and distribution outlets-this talented group at MPE is poised to take advantage of this unique opportunity and I'm proud to be a part of it."</p>
            <p>A Connecticut resident, McCarthy most recently served as the CEO and Alternate Governor of the St. Louis Blues, where he oversaw day-to-day operations for the NHL franchise, guiding the team to its first Central Division title in over 10 years, and driving revenue growth to unprecedented heights for the club. He was also directly responsible for operating the Scottrade Center, the 7th most active arena in the United States, and the re-opened  and renovated Peabody Opera House. As a founding partner of SCP Worldwide, he was chairman of the highly acclaimed sports, entertainment and media production company, Tupelo Honey Productions, driving significant revenue growth and client base for the firm.</p>
            <p>Prior to joining SCP Worldwide, McCarthy served as President of Madison Square Garden Networks Group, a position he rose to during his 23-year career with the organization. During his tenure, he oversaw  production, programming,  ad sales, marketing, new media, technical operations and affiliate sales efforts that led to an extraordinary 50 Emmy Awards and 250 Emmy Award Nominations as well as a host of other accolades that included the national Cable ACE Award, an International Festival Award, two Pro Max Marketing Awards, a Bandies Award and The Mark Award. Besides being recognized for excellence in traditional television production and programming, McCarthy initiated a series of innovations that helped make MSG one of the most technically advanced regional networks. Those innovations included the introduction of High Definition Television (HDTV) in 1998 when MSG aired the first regularly scheduled sports events covered in HD.</p>
            <p>As the leader of Madison Square Garden Networks Group, Mr. McCarthy had the responsibility of overseeing the entire operation of MSG Network, Fox Sports Net New York, MSG Radio, MSG ITV and MSGNetwork.com. He managed budgets of  almost $400 million in revenue and over $200 million in expenses, while overseeing over 200 staff and another 300 freelance employees. 
Manhattan Place Entertainment has produced award winning content for every broadcast network, major cable outlets, worldwide advertising agencies, Public relations and marketing firms, as well as a who's who of corporate clients including: ABC Television, ABC Sports, Disney/ABC Digital, ESPN, Euro RSCG, HAVAS Worldwide, Glam Media, FX Networks, Speed TV, Kraft, TV Food Network, Madison Square Garden Advertising, The New York Knicks, The New York Rangers, Nickelodeon, Paramount Pictures, VH-1 Movies, Original Media, Noise Digital, Trailer Park, Versus, Turner Sports,  NBC Sports, General Electric, CBS Sports, Comedy Central (The Daily Show), Ford Motor Company, Intel, WWE, FOX Sports, HBO Sports, Directv, Burson Marstellar, Red Bull, and Brandarc.</p>
            <p><strong>About Manhattan Place:</strong></p>
            <p>Since its inception in 1987 Manhattan Place Entertainment has maintained a reputation as one of the most respected television production companies in the entertainment industry. From concept through to final deliverables, they are a direct source for every type of service in the realm of film, video and digital production.</p>
            <p>From Super Bowls to PSA's with former Presidents of the United States, Manhattan Place Entertainment has produced content that has been viewed by audiences literally in the tens of millions, across all platforms, all over the world. Along the way they have garnered dozens of the industry's top honors including multiple Emmy Awards, Promax Awards, Telly Awards, and Cine Eagles, while helping their partners win dozens and dozens more. Originally renowned as a boutique shop for field production and on-location shooting, MPE has transformed and grown to develop, produce, and expertly deliver a wide range of content in long, short and medium format.  From live sporting and entertainment events, to advertising campaigns, commercials, and episodic television, MPE is a direct source for facilitating and executing any type of production at the highest level.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>"Usually, when you do 100 shows or 130 shows, you kind of start to break even around 30." said Mick Jagger.  "If you only do 7 shows you're never going to break even."</p>
            <p>So, the idea of a doing a live pay per view concert was put into motion!  And with that in mind, a strong pay-per-view partner was needed. Enter WWE. WWE, the world's pre-eminent provider of pay-per-view programming, in partnership with the Dainty Group and Endemol (the tour's promoters), will be distributing and marketing the pay-per-view event entitled "One More Shot".</p>
            <p></p>
            <img class="float_left" src="images/recent-work/stones2.jpg" alt="WWE and MPE collaborate on Rolling Stones promotional shoot!"  />
            <p>Manhattan Place Entertainment had the great fortune of being asked by WWE to shoot a variety of material with members of the band to help promote the upcoming live pay per view.</p>
            <p>"I'm not going to lie, this was one of those times where I would have paid to be on this shoot."  said Steve Cohen who was the director of photography for Manhattan Place Entertainment.   "It was a once in a lifetime experience, and one I will never forget".  (Too bad Keith was home sick!)</p>
            <p>The live pay per view event entitled "One More Shot" is this Saturday, December 15th at 9pm.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
         <!-- Begin Article --> 
        <article class="article">
            ...
            <p>Since it takes (2) to Tango, the WWE once again "turned" (yes, another dance pun) to Manhattan Place Entertainment (MPE) to shoot another in its series of character vignettes.</p>
            <p>The latest spot features Fandango, a new Superstar who is a "smooth" operator both in the ring and on the ballroom dance floor!</p>
            <p>To get this project accomplished, MPE had to perform some quick "steps" of our own to meet the challenges involved, one of which was finding an available location that visually conveyed the look and feel of a network "Ballroom Dance Show" in less than 24 hours.</p>
            <p>We came up with several options and the choice was made to shoot at Manhattan's elegant Highline Ballroom.</p>
            <p>With Steve Cohen as Director of Photography, MPE handled all of  the production management providing such production services as camera department, lighting, grip, sound, make-up, wardrobe, casting, locations, and all of the manpower for the project. It all resulted in a piece that visually had a cinematic quality along with all of the glitz, glamour, and characteristic style of a TV dancing show.</p>
            <p>With our quick and efficient work against a tight deadline, we once again proved that as a production company we can deliver at a high level, regardless of circumstance.  You might say this was a case where we were happy to "do the hustle" for our client.</p>
            <p>The spot aired November 12th as part of the USA Network's Monday Night Raw series.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>The NYRA turned to MPE to produce a spot that highlights the importance of horse racing and breeding to the state's overall economy.</p>
            <p>The campaign illustrates how New York's more than 300 breeding farms, employing about 35,000 workers, make up a vital part of the state's economy.</p>
            <p>The spot combines exciting racing highlights from Aqueduct, Belmont and Saratoga, along with poignant imagery from New York's breeding farms.</p>
            <p>This spot crosses the finish line by emphasizing the central theme of the campaign, utilizing the branded slogan created by MPE for NYRA "The Racing Heart of New York."</p>
            <p>The campaign premiered during NBC'sports coverage of the 2012 Belmont Stakes and will continue to run throughout the year.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>The segments are airing as part of WWE's '"Monday Night Raw" television show on the USA Network.</p>
            <p>And in the latest installment, the partnership "rages" on, as we catch up with two WWE Superstars who are ordered to undergo anger management counseling.</p>
            <p>With Steve Cohen as the Director of Photography, MPE's cameras shot three different vignettes featuring Daniel Bryan and Kane.</p>
            <p>A pseudo-psychologist named Dr. Shelby tries to help them work through their anger issues, as the two Superstars examine the roots of their rage.</p>
            <p>Can these two share the ring without driving each other crazy?
WWE fans will soon learn the answers, as the vignettes helped set the stage for another big night for the WWE Universe.</p>
            <p>The videos can also be seen on the WWE's web site, and hopefully you'll have as much fun watching them as we did shooting them.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>Manhattan Place Entertainment is taking a trip uptown to a mysterious new 'haunt' on the Upper East Side.</p>  
            <p>It's "666 Park Avenue", a new show on ABC this fall, about an apartment building called 'The Drake" that might be possessed by supernatural forces.</p>
            <p>MPE was called upon to shoot behind the scenes footage and content about the show, which premieres Sunday, September 30th.
Taking our cameras on location to the scene of the series, we shot an interview with one of the stars, acclaimed singer and actress Vanessa Williams.</p>
            <p>She discusses her role on the show as Olivia Doran, the wife of the owner and landlord of the building.</p>
            <p>We also interviewed the show's costume designer for some insight into the cast's wardrobe, and shot footage of the show while it was in production, including the cast shooting their scenes, the costume area, and the crew at work.</p>
            <p>The footage will be used to promote the new series and give viewers an inside look at the people behind it.</p>
            <p>So look for MPE's work on the show's <a href="http://beta.abc.go.com/shows/666-park-avenue">web site</a>, and be sure and drop in at New York's most thrilling and chilling address: '666 Park Avenue', Sunday nights at 10 on ABC.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>Manhattan Place Entertainment steps into the ring with World Wrestling Entertainment, collaborating on a special feature for WWE's "Monday Night Raw".</p>  
            <p>Recently we headed to WWE headquarters in Stamford Connecticut, to shoot a humorous vignette promoting a match between two WWE superstars: David Otunga and World Heavyweight Champion Sheamus.</p>
            <p>The premise of the skit is a mock deposition, in which Otunga plays an attorney trying to ban Sheamus's most devastating weapon: the Brogue Kick, after he kicked Otunga's "client", fellow wrestler Ricardo Rodriguez.</p>
            <p>Seamus is forced to defend himself and he immediately sets the tone.  
When asked if he "solemnly swears", he starts swearing at his opponent, only to be told it's not that kind of swearing.</p>
            <p>Things continue to get more heated, until Sheamus brings the deposition to a crashing halt, by delivering one of his brogue kicks right into the camera.</p>
            <p>Luckily we still have a few cameras left.</p>
            <p>It all makes for an entertaining video, which aired September 10th as part of the buildup to the match between two of the WWE's top wrestlers.</p>
            <p>You can still catch it online on the WWE's web site, and we're sure you'll get a "kick" out of it.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
                <!-- Begin Article -->  
        <article class="article">
            ...
            <p>With the 2012 U.S. Open in full "swing", Manhattan Place Entertainment (MPE) is teaming up with the Tennis Channel on its coverage of the prestigious Grand Slam tournament.</p>  
            <p>MPE has been called upon to collaborate on a U.S. Open show called "Tennis Channel Academy" hosted by a tennis Hall of Famer Tracy Austin.</p>
            <p>MPE's cameras captured in-depth interviews with some of the biggest stars in tennis, including three-time U.S. Open champion Serena Williams, five-time champ Roger Federer, Olympic gold medalist Andy Murray and career Grand Slam winner Maria Sharapova.</p>
            <p>We also shot a feature on one of the most accomplished and inspirational players in tennis history, the late Arthur Ashe.</p>
            <p>Along with the player profiles, Manhattan Place is providing the visuals to establish much of the show's look, shooting branding scenics from around New York City, behind the scenes footage of the broadcast, on court action and the championship trophy itself.</p>
            <p>Tune in to The Tennis Channel throughout the rest of the USOpen tournament and you'll see some of MPE's best stuff "served" up.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>New trends are on display in Manhattan Place Entertainment's latest collaboration with <a href="http://www.glam.com/">Glam.com</a>.
</p>  
            <p>MPE shot a video on the Motions line of hair products, featuring women getting natural hair makeovers.</p>
            <p>Performing the makeovers was celebrity hairstylist and beauty expert Ursula Stephen, the hairstylist of choice for such stars as Rihanna, Keyshia Cole, and Michelle Williams.</p>
            <p>Ursula helped show the bloggers how Motions hair products can help African-American women wear natural hairstyles in various types, including curly, wavy, curly kinky, and kinky coiled.</p>
            <p>Three lucky contest winners received new hairstyles, as well as an all-expenses paid trip to New York City!</p>
            <p>They also had the chance to showcase their new look in a special Motions spread in Essence Magazine.</p>
            <p>It was all part of a new campaign to introduce the company's new line of natural hair care products, 'Motions Naturally You'!</p>
            <p>Check out their style, and ours, at <a href="http://www.glam.com/">Glam.com</a>.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        ...
        <article class="article">
            ...
            <p>The objective was to show the excitement, grandeur and history of thoroughbred racing in the state of New York, while enticing fans to visit the state's three most fabled venues for "The Sport of Kings": Aqueduct, Belmont and Saratoga race tracks.</p>
            <p>The campaign also highlights the importance of the thoroughbred racing industry to the overall economy of New York State.</p>
            <p>"Our company needed two signature commercial spots and MPE delivered beyond all expectations." said Dan Silver NYRA's Director of Communications & Media Relations.  "The final product was of the highest quality.  Their professionalism and talent was evident in every step of the creative process."</p>
            <p>MPE created the new brand slogan, "The Racing Heart of New York"for the campaign and animated the NYRA logo to simulate a pumping heart beat.</p>
            <p>Mr. Silver added, "It was a pleasure to work with MPE. We would highly recommend them to anyone in search of a supremely talented and easy to deal with production team."</p>
            <p>The campaign premiered during NBC Sports' coverage of the 2012 Belmont Stakes.</p>
            <p>MPE is proud to have helped NYRA bring this winner across the finish line.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>What you may not have known is that Manhattan Place Entertainment (MPE) has been "Do-ing" its part on the video production side of the campaign.</p>
            <p>Euro RSCG Worldwide, the ad agency behind "DO EVERYTHING.  DO ANYTHING.  DO AC", along with the Atlantic City Alliance were faced with the task of capturing spectacular images of the special events that took place on the Atlantic City beach and boardwalk this past 4th of July. With an extremely high "visual" standard in mind, they once again turned to MPE.</p>
            <p>"Working with Steve Cohen and the crew at Manhattan Place Entertainment was a fantastic experience!" said Euro RSCG producer Lisa Christman.  "The footage looks amazing and both the agency and AC clients are thrilled with the final video."
</p>
            <p>"It was a pretty cool gig" said Steve Cohen of Manhattan Place Entertainment. "The main challenge was coming up with a plan that enabled us to be in multiple locations  "simultaneously" so that we wouldn't miss anything that was going on that day.  Having 6 camera crews helped!.  I think we got some very pretty looking images and I'm really proud of the way the video turned out".</p>
            <p>The day's events featured a free concert with recording star Kevin Rudolf, who performed his hit "Let It Rock", which is the theme song of the "DO EVERYTHING. DO ANYTHING. DO AC." campaign.</p>
...
After the sights and sounds of the music and fireworks, the night was topped off by the premiere of the dazzling "Duality" 3D light show.</p>
        ...
        <article class="article">
            ...
            <p>An international sporting event - at the Crossroads of the World, Times Square. And Manhattan Place Entertainment is there to bring it all to viewers, on the scene and on TV.</p>  
            <p>Global Media turned to MPE to bring its production expertise to 'The Grapple in the Apple", an Olympic qualifying wrestling match between the USA and Russia.</p>
            <p>The match was hosted by Beat The Streets, a non-profit organization that promotes the sport of amateur wrestling.</p>
            <p>It was the latest example of MPE using its complete production capabilities to successfully execute a project.  With Steve Cohen as Director, we set up an elaborate four-camera shoot, and handled all aspects of the live production on the technical end.</p>
            <p>The match was shown live on the Times Square Jumbotron in front of an estimated crowd of 20,000, and televised two weeks later on the NBC Sports Network.</p>
            <p>In the end, the United States thrilled the crowd with a 4-3 victory over the Russians, and Coleman Scott earned the final spot on the U.S. men's freestyle team for the London Olympics in August.</p>
            <p>But one of the biggest winners was Beat The Streets, as the event raised $1.4 million to help the organization expand and develop wrestling programs in the New York area.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>MPE was recognized with the Telly Awards' highest honor: a Silver, in the category of Best Sports Segments and Best Promotional Piece in Sports.</p>
            <p>We teamed up with the Knicks on the open that was played on the Madison Square Garden video screen before every home game at MSG.</p>
            <p>For this project, we shot specialized images of the Knicks players, headlined by their three stars; Carmelo Anthony, Amare Stoudemire, and Tyson Chandler.</p>
            <p>But the production was not without its share of challenges.</p>
            <p>Working with a professional sports franchise often dictates where, when and how a shoot can be carried out. And in this case, the only space available that would meet our needs and the productions design was the Zamboni garage used by the New York Rangers. </p>
            <p>Despite the icy temperatures inside, the players still had to wear their basketball jerseys and shorts.</p>
            <p>So the Knicks, who are used to sweating it out on the hardwood, ended up with goose bumps because of the chilly conditions.</p>
            <p>But when the open was completed and played on the MSG video screen, it was the fans who got goose bumps from the emotion of the piece, with its electrifying combination of music, game action, player images and New York scenics.</p>
            <p>It resulted in our third Telly of 2012, and the 15th overall for Manhattan Place Entertainment.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>Chrissy is a Sports Illustrated supermodel who's appeared on the cover of many magazines, including Esquire, Glamour, and Cosmopolitan.</p>
            <p>Allison is a media personality who is the TV host of FUSE's Top 20 Countdown, and also hosts 'Cosmo For Guys' on Cosmo Radio.</p>
            <p>Together, the two introduce clips from some of the most popular musical artists, while sharing lighthearted tips for enjoying summer in New York, from beaches to barbecues to concerts.</p>
            <p>"In this case we not only shot and directed the wraparound segments, but got to use the outdoor space in our offices as well", said Steve Cohen, who is the President of Manhattan Place Entertainment. "I guess you could say we had the 'home court' advantage on this shoot.</p>
        ...
        <article class="article">
            ...
            <p>Manhattan Place Entertainment (MPE) utilized the Action Camera Car system to shoot a live action "simulation" of the road course that will be driven by the worlds greatest race cars drivers in next years Formula 1 Grand Prix. The race will take place along the banks of the Hudson River in  the towns of Weehawken and West New York, NJ in the spring of 2013.</p>  
            <p>The promotional piece featured intense shots of the actual race course as well as breathtaking scenes of the New York skyline and Hudson River from the vantage point of the road course.</p>
            <p>The Action Car System is built on a Porsche Cayenne chassis and features a remote controlled crane that moves up down and swings 360 degrees around the vehicle... while the vehicle moves at high rates of speed!</p>
            <p>Amazingly the vehicle can easily run at 70 miles an hour and perfectly stabilize any camera shot at top speed.  It is ideal for shooting action sequences that require tracking other vehicles moving at high speed.</p>
            <p>"It's a pretty wild rig" said Steve Cohen who was the director on this project, "there are five people jammed inside a Porsche Cayenne all specializing in their one area.  In the front row there is the driver who is an expert in high speed chase driving. Next to him is the boom operator who controls the movement of the crane. In the back row there is the operator working the remote controls for the camera (tilt, pan and framing) and myself watching the monitor, and finally our camera assistant who is tucked away in the back hatch handling remote zoom and focus".</p>
            <p>"All of us simultaneously had to coordinate our individual efforts and work as a cohesive unit in order to successfully capture stellar imagery... while going at 70 miles an hour through the streets of Weehawken! The sum had to be greater than the individual parts in order for this to work, and in this case it was".</p>
            <p>As always, MPE is 'driven' to use the state of the art technology to help enhance the level of production quality and production value that we deliver.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        ...
        <article class="article">
            ...
            <p>With the Knicks and Rangers both involved in the 2012 playoffs, MSG Network turned once again to its long-time partner, Manhattan Place Entertainment (MPE), to help create the look and tone of its playoff coverage.</p>  
            <p>MPE shot stylized elements with players from both teams that were used for a series of vignettes that ran on MSG during the postseason.</p>
            <p>The spots included close-up interviews with players talking about the passion, intensity, and tradition of the playoffs, and what it meant to them to be competing for the ultimate prize in their sport.</p>
            <p>The vignettes conveyed the message: "The playoffs on MSG. Its Different Here".  MPE's spots ran throughout the playoffs, on MSG.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>The episodes showcase six bloggers getting a full makeover with clothing from the Rock and Republic Line.</p>  
            <p>The make-over participants each describe their favorite pieces and explain how the items reflect their personal style.</p>
            <p>Just like the clothing line, the videos have their own distinct look: stylized shooting with fast-paced editing to upbeat music, reflecting the excitement of the launch of Rock and Republic at Kohl's.</p>   
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>One was for a project marking the 10 year anniversary of 9/11, a poignant piece shot for FOX NFL Sunday.
            Shot and directed by Steve Cohen and Alan Jacobsen, the feature illustrated how football played a part in the healing process in the days and weeks after the terrorist attacks.</p>
            <p>The second Telly award was for 2011/2012 The New York Rangers lights out introduction.</p>  
            <p>The introduction is played before every home game on the big screens inside the arena at MSG.</p>  
            <p>Utilizing Manhattan Place's signature style of sports cinematography, a montage of original player images was incorporated with game action, New York City scenics, and dramatic music to create an electrifying pre-game intro for the fans to enjoy.</p>
            <p>MPE is proud to once again be recognized among the best in the business!</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        <!-- Begin Article -->  
        <article class="article">
            ...
            <p>The production company Pretty Bird turned to MPE's Steve Cohen to be one of the Directors of Photography on its commercials starring the multi-Grammy award winning singer.</p>
            <p>The spots feature sitdown interviews with Beyonce, to promote her association with Target retail stores.</p>
            <p>In one of the spots, Beyonce talks about what makes Target such an appealing place to shop.</p>
            <p>The other spot focuses on the deluxe edition of her latest album '4', released exclusively by Target and featuring three new songs, along with three remixes.</p>
            <a class="back-to-top" href="#top">Back to Top</a>       
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>In the infomercial, Jennie takes viewers on the 'Keurig Vue Brewer Journey Across America'. She travels around the country, spreading the word about the new Keurig that personalizes the brewing process to bring people stronger, bigger, and hotter cups of coffee just the way they like it.</p>
        ...
        <article class="article">
            ...
            <p>In producing this video, MPE interviewed the most prominent leaders and supporters of the foundation, shot extensive footage of stem cell research in the lab, and consulted closely with NYSCF on all aspects of the editorial content.</p>   
             <p>The video, titled "A Bridge To Cures" premiered at NYSCF's Sixth Annual Gala Dinner Celebration in October 2011.</p>
            <p>To view this video click on the photo above or go to NYSCF's website at www.nyscf.org</p> </div>
            <a href="#top">Back to Top</a>
        </article>
        <!-- end article -->    
        ...
        <article class="article">
            ...
            <p>MPE teamed up with the Knicks on the open that is being played on the Madison Square Garden video screen before the Knicks take the court for their games at MSG.</p> 
            <p>Using MPE's signature style of shooting, lighting, and pacing, a montage of original player images was incorporated with New York City scenics and game action to create an electrifying pre-game intro.</p> 
            <p>We're proud to help MSG and the Knicks keep the Garden rocking this season!</p>
            <a href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>Manhattan Place Entertainment was in high gear with its recent production work for SPEED Channel.</p>
            <p>Over a period of 2 weeks, MPE took its cameras and crews all over Daytona Beach, acquiring various branded elements for SPEED's on-air look, culminating in a marathon day of shooting with 36 different drivers from the Sprint Cup Series prior to the Daytona 500.</p> 
            <p>SPEED utilized MPE's vast production capabilities and commissioned MPE to design and build four individual racing related sets where distinctive images of each of the drivers could then be captured.</p>
            <a>
                <img class="float_left" src="_img/recent-work/matt-kenseth.jpg" alt="Matt Kenseth"  />
            </a>
            <p>A rotation system was put into place so that each driver could be photographed in each of the (4) environments in a "timely" manner.   MPE was given the challenge of having a total of (5) minutes with all of the drivers at each set.  That's video productions version of a "pit-stop", but once again, MPE raced across the finish line with flying colors (this is our 12th year shooting NASCAR related imagery).</p>
            <p>Steve Cohen executive produced for MPE and acted as director and directory of photography on-site, leading a team of talented production designers, set builders, producers, camera and lighting technicians and other production support teams.</p>   
            <p>Between the branded elements, and driver portraits, the original footage shot by MPE will be used in a multitude of ways during SPEED's year-long NASCAR coverage, beginning with the Daytona 500.</p>
            <a href="#top">Back to Top</a>
        </article>
        <!-- end article -->    
        ...
        <article class="article">
            ...
            <p>The spots, titled "Voices of Harlem", featured young African-American poets from Urban Word NYC, a youth development and education program, performing their original poems.</p>
            <p>Directed by Steve Cohen, MPE shot them reading their poems, with scenes of Harlem and famous New York City African-Americans projected on a screen in back of them.</p>
            <p>These unique vignettes aired on MSG and MSG+ throughout the month of February, as part of the network's special Black History Month programming.  They can also be seen on <a>MSG.com</a></p>
            <a href="#top">Back to Top</a>
        </article>
        <!-- end article -->    
        ...
        <article class="article">
            ...
            <p>Manhattan Place Entertainment caught up with one of the hottest recording artists in music, rapper Cee Lo Green, for a special in-depth interview for DIRECTV.</p>
            <p>In an elaborate multi-camera shoot for HD and 3D MPE sat down with Cee Lo before his small private concert at the Gansevoort Hotel in New York City.</p>
            <p>The interview came at the height of his popularity, as Cee Lo's song 'Forget You' was one of the top-selling singles of 2011.</p>
            <p>The concert for which MPE shot the interview aired New Year's Eve exclusively on DIRECTV's Audience Network, as part of DIRECTV's 'Old School Challenge'.</p>
            <a href="#top">Back to Top</a>
        </article>
        <!-- end article -->    
        ...
        <article class="article">
            ...
            <p>Starring in the spots is Sherri Sheppard, the Emmy-award winning co-host of the daytime talk show, 'The View'.</p>
            <p>With Steve Cohen as Director of Photography, the lighthearted videos feature Sherri in her 'Powerful Moments of Truth'… the instant when she makes the switch from a manual to a power toothbrush, and realizes the positive impact it will have on her teeth.</p> 
            <p>The spots are meant to not only entertain viewers, but encourage them to use power toothbrushes to improve their oral health.</p>
            <p>To see Sherri and MPE's Powerful Moments of Truth, or in this case, Moments of 'Tooth', click on the link below.</p>
            <a href="#top">Back to Top</a> 
        </article>
        <!-- end article -->    
        ...
        <article class="article">
            ...
            the Speed Channel.</p>
            <p>Recently MPE was in Miami and teamed up with Speed Producer, Gary Lang, to shoot a series of promotional branding elements, as part of the channel's coverage of NASCAR's 2011 Championship Week.</p>
            ...
            <p>The specialty shots will be shown in various forms, including promos and elements for Speed's shows such as Speed Center, Trackside Live, Race Day and Victory Lane.</p>
        ...
        <article class="article">
            ...
            <p>In association with Long Pond Media, and with Steve Cohen as Director of Photography, MPE shot an episode of the unusual interview series.</p>
            <p>It features celebrities delving into personal mementoes from their past and sharing some of the experiences of their youth that shaped them into the people they are today.</p>
            <p>This particular episode features actor and filmmaker Ed Burns opening up about his childhood memories and the influence of his father, a New York City police officer who had his kids 'doing time' to keep them out of trouble.</p>
            <p>The show shot by MPE can be seen as part of 'The Mortified Sessions', airing Friday nights at 7pm on the Sundance Channel.</p>
            <a href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>MPE shot a special tease that features two members of the famed Tuskegee Airmen, the first unit of African-American fighter pilots, who fought in World War II.</p>
            <p>The tease also includes Oscar-winning actor Terrence Howard, who will be starring in an upcoming film about the Airmen, "Red Tails".</p>
            <p>The Tuskegee Airmen are being honored on the 70th anniversary of their service with a tribute during three NFL games this Sunday, November 13th.</p>
            <p>Look for MPE's Veteran's Day tease honoring these heroic pioneers on Fox NFL Sunday.</p>
            <a href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>MPE collaborated with DIRECTV to shoot a series of 4 promos for the 'The Dan Patrick Show', the TV version of his popular radio show.</p>
            <p>The promo will spotlight the nationally syndicated program, which features sports talk, interviews, and Dan's unique brand of wit.</p>
            <p>It airs on The Audience Network, DIRECTV's original programming channel.</p>
            <a href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>The Depth Chart</p>  
            <p>Manhattan Place Entertainment recently took the field for its latest sports project: a documentary on college football produced by DLP Entertainment for ESPN.</p>
            <p>MPE was recruited by DLP Entertainment to provide the crews, equipment, and Directors of Photography for the production.</p>
            <p>DLP's executive producer Mike Hughes wanted a certain stylized visual look for the show, and knew he could turn to MPE to create it.</p>
            <p>For this particular project, we hit the road to follow teams and players in four different collegiate programs including: Auburn, University of Wisconsin,  Oklahoma State University, and University of Arkansas,  providing exceptional production services for each location.</p>
            <p>The documentary will air over a stretch of five weeks, providing viewers with a revealing look inside the world of college football.</p>
            <p>Look for our work on ESPN this fall.</p>
            <a href="#top">Back to Top</a> 
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>To mark the 10th anniversary of 9/11, Manhattan Place Entertainment partnered with Fox Sports to create a poignant piece for FOX NFL Sunday.</p>
            <p>MPE shot a feature that illustrates how football played a part in the healing process, in the days and weeks after the terrorist attacks.</p> 
        ...
        <article class="article">
            ...
            <p>As part of the promotional effort for the series, MPE took its cameras to the set at Steiner Studios in Brooklyn.</p>
            <p>We interviewed real life Pan Am stewardesses, to gain some insight into what it was like in those earlier days of air travel.</p>
            <p>'Pan Am', starring Christina Ricci, premieres Sunday Sept. 25th at 10p.m. on ABC, and MPE is glad to be along for the ride.</p>
            <a class="back-to-top" href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>Scoring a touchdown for Fox Sports and taking the checkered flag for Versus, Manhattan Place Entertainment continues to provide award-winning content for our clients across all forms of media.</p>
            <a class="back-to-top" href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>MPE was called upon recently to shoot a promo for the Emmy Award-winning original series.</p>
            <p>With Steve Cohen as the Director of Photography, we went behind the scenes with the talented cast on their set at Steiner Studios in Brooklyn.</p>
            <p>The show, starring Glenn Close and John Goodman, is seen on the DirecTV channel 'Audience Network' and has won numerous awards, including a Golden Globe and several Emmys.</p>  
            <p>MPE's gripping promo was used for season four of the show, which premiered in July.</p>
            <a class="back-to-top" href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>MPE, the Emmy, Promax, Cine Eagle and Telly Award winning production house, completed a series of three spots, from providing the creative concepts to overseeing every aspect of production.</p>
            <a><img alt="St. Vincent's Medical Center Logo" src="_img/recent-work/bts-st-vincent-logo.jpg" class="float_left"></a>
            <p>Two of the spots feature cancer survivors telling their poignant stories of the life-saving treatment and compassionate care they received at St. Vincent's.</p>
            <p>The other spot showcases the state of the art Novalis radiation device that has given the hospital a powerful new tool for treating tumors.</p>
            <p>MPE handled the interviews with the patients, shooting treatment facilities at St. Vincent's, research and scriptwriting to convey the hospital's cancer care approach, and all phases of production from creative through to delivery of the final spots.</p>
            <p>The three commercials are currently airing as regional spots in the New York metropolitan area.  MPE is proud to have teamed up with St. Vincent's, in its efforts to bring high quality cancer care to area patients.</p>
            <a class="back-to-top" href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>This marks the 8th time that MPE has created content for the Super Bowl, America’s most highly viewed televised event.</p>
            <a class="back-to-top" href="#top">Back to Top</a>
        </article>
        <!-- end article -->
        ...
        <article class="article">
            ...
            <p>MPE’s Steve Cohen shot and directed both features that aired during the FOX Sports coverage of Super Bowl XLV.</p>
            <a class="back-to-top" href="#top">Back to Top</a>
        </article>
        <!-- end article -->    
        ...
        <article class="article">
            ...
            <p>Danica Patrick IZOD Indy Car Series Driver</p>
            <p>MPE shot all of the worlds most well known Indy Car drivers and created stylized live action portraits as well as other specialty visual elements.</p>
            ...
            <p>MPE was responsible for handling the directing, cinematography, lighting, art direction, set construction, and all other technical aspects of the shoots, and contributed
            to the creative as well.</p>
            <p>The footage can be seen on Versus coverage of the Indianapolis 500 and throughout the entire 2010 IZOD Indy Car Series season on Versus.</p>
            <a class="back-to-top" href="#top">Back to Top</a>
        </article>
        <!-- end article -->
