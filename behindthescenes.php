...
Provided all pre-production and field production services. Handled production design utilizing 4 video projection units to create a unique cutting edge environment for players and coaches from each PAC-12 institution to appear in front of. The promos air across the PAC-12 Networks throughout the 2014-2015 Basketball season. Shot on location at the PAC-12 Networks sound stage in San Francisco, CA.</p>
        ...
        <div class="article">
        	...
        	<p class="date">Supervising Producer: Jonathan Stewart</p>
        	<p class="date">DP: Brian Schulz</p>
        	<p class="date">2nd Unit: Joe White</p>
        	<hr/>
            <p>MPE provided all field production services for this shoot featuring Tom Selleck. In a segment called “Life Advice”, Selleck offers his insights in response to questions coming from GQ followers. Shot on location in NYC.</p>
            <img class="float_left" src="images/recent-work/mpe003.jpg" alt="GQ Life Advice with Tom Selleck"  />
            <a class="back-to-top" href="#top">Back to Top</a>       
        </div>
        <!-- end article -->
        <!-- Begin Article -->  
