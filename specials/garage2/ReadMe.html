...
<html>
<head>
	<title>QuickTime Pro - Export for Web - Bayonne</title>
...
<table>
	<tr>
		...
		<td><h1>Instructions for posting <i>Bayonne</i> to your website</h1></td>
	</tr>
</table>

<div id="summary">
	<p>You have exported <i>Bayonne</i> using QuickTime Pro.  The following information will help you post this movie to your website.</p>
...
<script type="text/javascript"><!--
	QT_WritePoster_XHTML('Click to Play', 'Bayonne-poster.jpg',
		'Bayonne.mov',
		'640', '448', '',
		'controller', 'true',
		'autoplay', 'true',
...
<noscript>
<object width="640" height="448" classid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
	<param name="src" value="Bayonne-poster.jpg" />
	<param name="href" value="Bayonne.mov" />
	<param name="target" value="myself" />
	<param name="controller" value="false" />
	<param name="autoplay" value="false" />
	<param name="scale" value="aspect" />
	<embed width="640" height="448" type="video/quicktime" pluginspage="http://www.apple.com/quicktime/download/"
		src="Bayonne-poster.jpg"
		href="Bayonne.mov"
		target="myself"
		controller="false"
		autoplay="false"
...
<div id="textembed">
	...
	<ul>
		...
		<li>The movie URL parameters must always point to the reference movie (<a href="Bayonne.mov">Bayonne.mov</a>) rather than a source movie.</li>
...
<ul>
	<li>Reference Movie:
		<ul><li><a href="Bayonne.mov">Bayonne.mov</a></li></ul>
	</li>
	<li>Poster Frame:
		<ul><li><a href="Bayonne-poster.jpg">Bayonne-poster.jpg</a></li></ul>
	</li>
	<li>Versions:
		<ul>
		<li><a href="Bayonne-desktop.m4v">Bayonne-desktop.m4v</a></li>
		<li><a href="Bayonne-iPhone-cell.3gp">Bayonne-iPhone-cell.3gp</a></li>
		<li><a href="Bayonne-iPhone.m4v">Bayonne-iPhone.m4v</a></li>
		</ul>
	</li>
</ul>
</div>
