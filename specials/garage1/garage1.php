...
<head>
<title>DP: Steve Cohen - The Promoter</title>
...
<body>
    ...
    <div class="panel">
    	...
    	<div class="garage">
    		<p>
    			<span class="description">DP:</span> Steve Cohen 
    			<br /> Manhattan Place Entertainement
    			<br />
    			<br /> <span class="description">Production Services:</span>	Manhattan Place Entertainment
    			<br />
    			<br /><span class="description">Production Service:</span> <br />In a Garage
    			<br /><br /><span class="description">Producer:</span> Ethan Wilson
    		</p>
    	</div>
        <div class="container">
            ...
            <div id="video">
                <script>
                    QT_WritePoster_XHTML('Click to Play', 'The_Promoter-poster.jpg',
                		'The_Promoter.mov',
                		'640', '448', '',
                		'controller', 'true',
                		'autoplay', 'true',
