...
<head>
<title>St. Vincent Extraordinary</title>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            <h3 style="margin:0 0 20px 40px;">St. Vincent's Medical Center "Extraordinary"</h3>
            <div id="video">
                <script type="text/javascript">
                    QT_WriteOBJECT('../../video/st-vincent-extraordinary/st-vincent-next.mov', '640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;
                </script>
            </div>
        </div>
    </div>
