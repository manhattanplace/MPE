...
<head>
<title>Steve Cohen - Director: Sports Reel</title>
...
<body>
    ...
    <div class="panel">
    	...
    	<h3 class="library">STEVE COHEN <br /> DIRECTOR<br /> SPORTS REEL</h3>
    <div class="container">
        <div class="back_button1">
        	<a href="/index.php">&laquo; Back to Home</a>
        </div>
        <div id="video_720">
            <script>QT_WriteOBJECT('steve.mov','720', '496', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;</script>
        </div>
