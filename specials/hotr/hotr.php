...
<body>
    ...
    <div class="panel">
    	...
    	<div class="garage hotr">
    		<p>
    			<span class="description">Title:</span>	Hero of the Rails
    			<br />
    			<span class="description">Client:</span> HIT Entertainment
    			<br />
    			<span class="description">Director:</span> Steve Cohen
    			<br />
    			<span class="description">Production Services:</span><br />Manhattan Place Entertainment
    			<br />
    		</p>
    	</div>
        <div class="container">
            ...
            <div id="video_550">
                ...
                QT_WritePoster_XHTML('Click to Play', 'thomas-and-friends.jpg',
            		'hotr.mov',
            		'540', '320', '',
            		'controller', 'true',
            		'autoplay', 'true',
