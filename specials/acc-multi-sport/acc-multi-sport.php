...
<body>
    ...
    <h3 style="margin:0 0 20px 40px;">ACC Multi Sport</h3>
    <div class="container">
        <div id="video">
            <script type="text/javascript">
                QT_WriteOBJECT('../../video/acc-multi-sport/acc01.mov', '640', '376', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;
            </script>
        </div>
    </div>
</div>
