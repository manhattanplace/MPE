...
<head>
<title>Celebrity Cruise Timelapse</title>
...
<body class="cct">
    ...
    <div class="panel">
        ...
        <div class="container">
    		<p class="garage hotr">
    			<span class="description">Title:</span>	Celebrity Cruise Timelapse
    			<br />
            ...
            <div id="video" style="width:437px;">
                <script>QT_WriteOBJECT('Celebrity-Cruise-Timelapse.mov', '427', '256', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;</script>
            </div>
