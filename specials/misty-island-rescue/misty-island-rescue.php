...
<head>
<title>Misty Island Resuce</title>
...
<body>
    ...
    <div class="panel">
    	...
    	<div class="garage hotr">
    		<p>
    			<span class="description">Title:</span>	Misty Island Rescue
    			<br />
        ...
        <div class="container">
            ...
            <div id="video_550">
                ...
                QT_WritePoster_XHTML('Click to Play', 'misty-island-rescue-poster.jpg',
            		'misty-island-rescue.mov',
            		'540', '320', '',
            		'controller', 'true',
            		'autoplay', 'true',
            		'bgcolor', 'black',
