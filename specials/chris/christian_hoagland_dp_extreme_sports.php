...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            <h3 style="float:right;margin:60px 20px 0 0">CHRISTIAN HOAGLAND <br /> DP<br /> EXTREME SPORTS REEL</h3>
            <div class="back_button1">
            	<a href="../../index.php">&laquo; Back to Home</a>
            </div>
            <div id="video">
                <script>
                    QT_WriteOBJECT('chris.mov', '640', '496', '', 'AUTOPLAY', 'True', 'SCALE', 'Aspect') ;
                </script>
            </div>
