...
<html lang="en">
<head>
<title>Impractical Jokers - truTV 'KFC How do you prepare to dare?'</title>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            ...
            <div id="video">
                <script>QT_WriteOBJECT('/videos/kfc-2/kfc-2.mov', '640','376','', 'AUTOPLAY','True','SCALE','Aspect') ;</script>
            </div>
