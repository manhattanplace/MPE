...
<html lang="en">
<head>
<title>Arizona Wildcats 'Ready For Battle' Promo</title>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            ...
            <div id="video">
                <script>QT_WriteOBJECT('/videos/pac-12-arizona/pac-12-arizona.mov', '640','376','', 'AUTOPLAY','True','SCALE','Aspect') ;</script>
            </div>
