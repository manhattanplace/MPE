...
<html lang="en">
<head>
<title>Impractical Joker's Marathon sponsored by Universal Pictures 'Ride Along'</title>
...
<body>
    ...
    <div class="panel">
        ...
        <div class="container">
            ...
            <div id="video">
                <script>QT_WriteOBJECT('/videos/ride-along-1/ride-along-1.mov', '640','376','', 'AUTOPLAY','True','SCALE','Aspect') ;</script>
            </div>
