...
<div class="panel">
    ...
    <div class="container about">
            ...
            <article>
                ...
                <p>Along the way we have worked one on one with the most well known people in the world including the biggest stars from film, television, entertainment, sports, music, fashion, and politics</p>
            ...
            <article>
                ...
                <p>We have had a major impact in the world of sports video production, helping to change the way feature profiles, teases,  show opens and in-arena presentations are created.</p>
                <p>We have proudly worked  multiple Olympic Games, and with every professional sports league including: Major League Baseball , The National Football League, The National Basketball Association, The National Hockey League, The United States Tennis Association, NASCAR, Major League Soccer, World Wrestling Entertainment and have worked directly for some of the most prestigious franchises in all of sports, creating campaigns and other various specialized content for use in broadcast and in-arena/in-stadium presentations.</p>
                <p>While we are extremely proud to have successfully delivered on these types of initiatives, some with budgets of up to 2 million dollars,  we <i>have not</i> and <i>never will</i> abandon the basic principles <i>or the basic services</i> that helped to establish us as a successful company.</p>
            ...
            <article>
                ...
                <p>In terms of <b>field</b> and <b>studio capabilities</b>, MPE has always provided production quality that is <b>world class</b>.  Our knowledge and experience in this area is unparalleled, and our body of work speaks for itself.</p>
                ...
                <p>As previously stated: we are a collective.  A unique combination of above the line and below the line personnel who are at the very top of their fields in virtually <b>every</b> specialized area of production execution, and content creation.</p>
            ...
            <article>
                ...
                <p>In our early days we used to joke:  It’s not the camera, man!  It’s the cameraman!  We used to laugh about that, but that statement was relevant then, and is just as relevant  today.  And it applies to <b>all</b> facets of content creation.</p>
            </article>
            <article>
